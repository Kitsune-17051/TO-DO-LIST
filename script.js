 const ul = document.querySelector("#taskList");
      ...
      addBtn.addEventListener("click", () => {
        ...
        if (!text) {
          log("<i class='fa-solid fa-triangle-exclamation warning'></i>  Cannot add empty task");
          input.focus();
          return;
        }
  ...
  `;
        ...
        log(`<i class="fa-solid fa-square-check add-icon icon"></i> Added: "${text}"`);
        input.value = "";
        input.focus();
        checkEmpty();
      });
      ...
      ul.addEventListener("click", (e) => {
        ...
        log(`<i class="fa-regular fa-trash-can garbage-can icon"></i> Deleted: "${text}"`);
        li.remove();
        checkEmpty();
      });
      ...
      ul.addEventListener("click", (e) => {
        ...
        if (li.classList.contains("editing")) {
          ...
          if (!newText) {
            log("<i class='fa-solid fa-triangle-exclamation warning'></i> Task cannot be empty");
            inputBox.focus();
            return;
          }
          ...
          log(`<i class="fa-solid fa-pen-to-square icon"></i> Editing: "${currentText}"`);
        }
      });
    ...
    //   Handling checkbox change ehre =========
      ul.addEventListener("change", (e) => {
        ...
        if (e.target.checked) {
          ...
          log(`<i class="fa-solid fa-check icon"></i> Completed: "${textSpan.textContent}"`);
        } else {
          textSpan.style.textDecoration = "none";
          log(`<i class="fa-solid fa-arrow-rotate-left icon"></i> Unchecked: "${textSpan.textContent}"`);
        }
      });
